const CACHE='nasza-legenda-pro-v04';
const ASSETS=['./','./index.html','./styles.css','./app.js','./logo.svg','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-512-maskable.png'];
